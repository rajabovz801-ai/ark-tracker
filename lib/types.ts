...
export type DeletedRecord={id:number;kind:'session';target_id:string;group_id:string|null;lesson_date:string|null;deleted_at:string;snapshot:{group?:{name?:string};session?:{id:string};attendance?:unknown[]}};
