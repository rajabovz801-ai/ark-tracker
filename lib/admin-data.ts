...
export async function loadAdmin(req:Request){
 ...
 const [groups,students,memberships,sessions,events,devices]=await Promise.all([
 ...
 return {groups,students,memberships,sessions,attendance,events,devices,admin};
}
